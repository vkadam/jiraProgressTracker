...
this["JiraTrackerTemplates"]["src/views/summary-div.hbs"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  buffer += "<div class=\"summary-div\">\n	";
  stack2 = helpers.each.call(depth0, ((stack1 = depth0.baseline),stack1 == null || stack1 === false ? stack1 : stack1.data), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
...
function program1(depth0,data,depth1) {
  ...
  buffer += escapeExpression(((stack1 = helpers.get || depth1.get),stack1 ? stack1.call(depth0, ((stack1 = depth1.latest),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.key), options) : helperMissing.call(depth0, "get", ((stack1 = depth1.latest),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.key), options)))
    + "</td>\n		";
  stack2 = helpers['if'].call(depth0, depth1.lastWeekSnapshot, {hash:{},inverse:self.program(7, program7, data),fn:self.programWithDepth(2, program2, data, depth1),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n			<td>:)</td>\n    </tr>\n    ";
  return buffer;
  }
function program2(depth0,data,depth2) {
  ...
  buffer += escapeExpression(((stack1 = helpers.subtract || depth2.subtract),stack1 ? stack1.call(depth0, ((stack1 = depth2.weekb4lastSnapshot),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = depth2.lastWeekSnapshot),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.key), options) : helperMissing.call(depth0, "subtract", ((stack1 = depth2.weekb4lastSnapshot),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = depth2.lastWeekSnapshot),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.key), options)))
    + " </td>\n			";
  stack2 = helpers['if'].call(depth0, depth2.latest, {hash:{},inverse:self.program(5, program5, data),fn:self.programWithDepth(3, program3, data, depth2),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n		";
  return buffer;
  }
function program3(depth0,data,depth3) {
  ...
  buffer += "\n				<td>";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.subtract || depth3.subtract),stack1 ? stack1.call(depth0, ((stack1 = depth3.lastWeekSnapshot),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = depth3.latest),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.key), options) : helperMissing.call(depth0, "subtract", ((stack1 = depth3.lastWeekSnapshot),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = depth3.latest),stack1 == null || stack1 === false ? stack1 : stack1.data), ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.key), options)))
    + " </td>\n			";
  return buffer;
  }
